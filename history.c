...
/**
 * obtainHistoryFile - acquires the history file
...
/**
 * createOrAppendHistory - generates a file or appends to an existing file
...
/**
 * constructHistoryList - appends an entry to a history linked list
...
/**
 * updateHistoryNumbers - assigns new numbers to the history linked list after modifications
 * @info: A structure containing potential arguments, used to maintain
 *
