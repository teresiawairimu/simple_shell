...
/**
 * copyEnvironment - provides a duplicate of our environ as a string array
...
/**
 * removeEnvironmentVariable - Deletes an environment variable
 * @info: A structure containing potential arguments, used to maintain
 *        a constant function prototype.
...
/**
 * setEnvironmentVariable - Creates a new environment variable or updates an existing one
 * @info: A structure containing potential arguments, used to maintain
 *        a constant function prototype.
 * @var: The string representing the environment variable property
