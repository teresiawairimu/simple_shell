...
/**
 * displayStringList - outputs only the str element of a list_t linked list
...
/**
 * removeNodeAtIndex - eliminates a node at the specified index
...
/**
 * deallocateList - releases all nodes of a list
